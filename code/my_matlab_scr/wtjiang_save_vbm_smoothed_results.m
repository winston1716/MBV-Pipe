function wtjiang_save_vbm_smoothed_results(T2_vbm_dir, saved_dir)
    ...
    invivo_results_data = invivo_results_mat.smoothed_volume_stats_results;
    ...
    perfused_results_data = perfused_results_mat.smoothed_volume_stats_results;
    ...
    fixed_results_data = fixed_results_mat.smoothed_volume_stats_results;
